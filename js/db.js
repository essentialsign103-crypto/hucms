...
const DB = (() => {
  ...
  function seedIfEmpty() {
    if (getAll('seeded').length > 0) return;

    // Staff / Users
    const users = [
      { id: 'u1', name: 'Dr. Sarah Mitchell', email: 'admin@clinic.com', password: 'admin123', role: 'admin', phone: '555-0101', department: 'Administration', status: 'active', joinDate: '2020-01-15' },
      { id: 'u2', name: 'Dr. James Carter', email: 'doctor@clinic.com', password: 'doctor123', role: 'doctor', phone: '555-0102', department: 'General Medicine', status: 'active', joinDate: '2019-03-10' },
      { id: 'u3', name: 'Emily Rodriguez', email: 'reception@clinic.com', password: 'recep123', role: 'receptionist', phone: '555-0103', department: 'Front Desk', status: 'active', joinDate: '2021-06-01' },
      { id: 'u4', name: 'Dr. Aisha Patel', email: 'aisha@clinic.com', password: 'doc456', role: 'doctor', phone: '555-0104', department: 'Cardiology', status: 'active', joinDate: '2018-09-20' },
      { id: 'u5', name: 'Mark Thompson', email: 'mark@clinic.com', password: 'staff123', role: 'receptionist', phone: '555-0105', department: 'Front Desk', status: 'active', joinDate: '2022-02-14' }
    ];
    ...
    // Doctors
    const doctors = [
      { id: 'd1', name: 'Dr. James Carter', specialization: 'General Medicine', email: 'doctor@clinic.com', phone: '555-0102', licenseNo: 'LIC-2019-001', experience: 12, availability: ['Monday','Tuesday','Wednesday','Thursday','Friday'], status: 'active', userId: 'u2' },
      { id: 'd2', name: 'Dr. Aisha Patel', specialization: 'Cardiology', email: 'aisha@clinic.com', phone: '555-0104', licenseNo: 'LIC-2018-002', experience: 15, availability: ['Monday','Wednesday','Friday'], status: 'active', userId: 'u4' },
      { id: 'd3', name: 'Dr. Robert Kim', specialization: 'Pediatrics', email: 'rkim@clinic.com', phone: '555-0106', licenseNo: 'LIC-2021-003', experience: 8, availability: ['Tuesday','Thursday','Saturday'], status: 'active', userId: null },
      { id: 'd4', name: 'Dr. Linda Osei', specialization: 'Dermatology', email: 'losei@clinic.com', phone: '555-0107', licenseNo: 'LIC-2017-004', experience: 18, availability: ['Monday','Tuesday','Thursday'], status: 'active', userId: null },
      { id: 'd5', name: 'Dr. Carlos Mendez', specialization: 'Orthopedics', email: 'cmendez@clinic.com', phone: '555-0108', licenseNo: 'LIC-2020-005', experience: 10, availability: ['Wednesday','Friday'], status: 'inactive', userId: null }
    ];
    ...
    // Patients
    const patients = [
      { id: 'p1', firstName: 'Michael', lastName: 'Johnson', dob: '1985-04-12', gender: 'male', phone: '555-1001', email: 'mjohnson@email.com', address: '123 Oak Street, Springfield', bloodType: 'A+', allergies: 'Penicillin', emergencyContact: 'Lisa Johnson - 555-1002', insurance: 'BlueCross #BC123456', status: 'active' },
      { id: 'p2', firstName: 'Sarah', lastName: 'Williams', dob: '1992-08-25', gender: 'female', phone: '555-1003', email: 'swilliams@email.com', address: '456 Maple Ave, Springfield', bloodType: 'O-', allergies: 'None', emergencyContact: 'Tom Williams - 555-1004', insurance: 'Aetna #AE789012', status: 'active' },
      { id: 'p3', firstName: 'David', lastName: 'Brown', dob: '1978-11-30', gender: 'male', phone: '555-1005', email: 'dbrown@email.com', address: '789 Pine Road, Springfield', bloodType: 'B+', allergies: 'Sulfa drugs, Aspirin', emergencyContact: 'Mary Brown - 555-1006', insurance: 'United Health #UH345678', status: 'active' },
      { id: 'p4', firstName: 'Emma', lastName: 'Davis', dob: '2001-02-14', gender: 'female', phone: '555-1007', email: 'edavis@email.com', address: '321 Elm Street, Springfield', bloodType: 'AB+', allergies: 'Latex', emergencyContact: 'John Davis - 555-1008', insurance: 'Cigna #CI901234', status: 'active' },
      { id: 'p5', firstName: 'Robert', lastName: 'Wilson', dob: '1965-07-08', gender: 'male', phone: '555-1009', email: 'rwilson@email.com', address: '654 Cedar Lane, Springfield', bloodType: 'O+', allergies: 'None', emergencyContact: 'Helen Wilson - 555-1010', insurance: 'Medicare #MC567890', status: 'active' },
      { id: 'p6', firstName: 'Jennifer', lastName: 'Martinez', dob: '1990-12-03', gender: 'female', phone: '555-1011', email: 'jmartinez@email.com', address: '987 Birch Blvd, Springfield', bloodType: 'A-', allergies: 'Codeine', emergencyContact: 'Carlos Martinez - 555-1012', insurance: 'BlueCross #BC234567', status: 'active' },
      { id: 'p7', firstName: 'Thomas', lastName: 'Anderson', dob: '1955-03-22', gender: 'male', phone: '555-1013', email: 'tanderson@email.com', address: '147 Walnut Way, Springfield', bloodType: 'B-', allergies: 'Ibuprofen', emergencyContact: 'Nancy Anderson - 555-1014', insurance: 'Aetna #AE890123', status: 'active' },
      { id: 'p8', firstName: 'Lisa', lastName: 'Taylor', dob: '1998-06-17', gender: 'female', phone: '555-1015', email: 'ltaylor@email.com', address: '258 Spruce St, Springfield', bloodType: 'AB-', allergies: 'None', emergencyContact: 'Mark Taylor - 555-1016', insurance: 'Cigna #CI012345', status: 'inactive' }
    ];
    ...
    const records = [
      ...
      { id: 'r2', patientId: 'p2', doctorId: 'd2', appointmentId: 'a5', date: fmt(yesterday), diagnosis: 'Mild Mitral Valve Regurgitation', symptoms: 'Occasional shortness of breath, fatigue', notes: 'Echo shows mild MR. No intervention needed at this time. Annual monitoring recommended.', vitalSigns: { bp: '118/76', pulse: '72', temp: '98.4', weight: '132 lbs', height: '5\'5"' }, type: 'Follow-up' },
      ...
      { id: 'r4', patientId: 'p5', doctorId: 'd2', appointmentId: 'a5', date: fmt(yesterday), diagnosis: 'Coronary Artery Disease', symptoms: 'Chest pain on exertion, shortness of breath', notes: 'Stress test positive. Referred for cardiac catheterization. Aspirin and statin therapy initiated.', vitalSigns: { bp: '138/88', pulse: '68', temp: '98.5', weight: '195 lbs', height: '5\'9"' }, type: 'Cardiology' },
      { id: 'r5', patientId: 'p6', doctorId: 'd4', appointmentId: 'a6', date: fmt(yesterday), diagnosis: 'Contact Dermatitis', symptoms: 'Itchy red rash on forearms, mild swelling', notes: 'Likely allergic reaction to new detergent. Topical corticosteroid prescribed. Avoid irritant.', vitalSigns: { bp: '115/72', pulse: '74', temp: '98.6', weight: '128 lbs', height: '5\'4"' }, type: 'Dermatology' }
    ];
